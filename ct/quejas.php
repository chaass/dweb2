...
<html lang="es">
  ...
  <!-- finalizarel slider HEAD section --></head>
...
<td style="height: 20px;">&nbsp;</td>
                ...
                <table align="center">
<tbody>
<td style="height: 98px; width: 722px; background-image: url('http://s2.subirimagenes.com/privadas/previo/thump_2256185banner.jpg'); background-repeat: no-repeat; margin-left: 90px; vertical-align: middle;" colspan="3"><span style="color: #ffffff; font-size: 25px; text-shadow: 1px 1px 1px #000000; font-weight: bold; text-align: center; margin-left: 15px;"> QUEJAS Y RECLAMOS</span></td>
</tbody>
               </table>
</div>
 ...
 <div class="caja-titulo">    
              ...
              <div id="fq">    
               <form name="" action="quejasP.php"  method="post">
                                ...
                                <h2 class="tf1">Dia del inconveniente</h2>
                                <input type="date" class="inf1" name="fecha" > <br>
                                <h2 class="tf1">Ciudad</h2>
                                <input type="text"  class="inf1" name="ciu"   placeholder="Identificación">                                       
                               <h2 class="tf1">Motivo de la queja</h2>
                                <textarea class="inf1" name="tq"></textarea><br><br>
                               <button class="bf1" >Enviar</button>
