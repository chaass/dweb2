                ...
                <div class="caja-contenido">
                 ...
                 <div id="tablc">
                  ...
                  <div id="tabl">     
                   ...
                   <label id="labelN">Verifique la informacion de su cita en la anterior tabla y proceda a Eliminar
                          su cita en el siguiente formulario.</label> <br><br>

                   <div id="formularioCrear">
                  <form name="" action="eliminarCita.php" method="post">
