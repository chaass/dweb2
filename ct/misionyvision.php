      ...
      <div id="login">
        ...
        <!--  <div>
            <img src="img/logo.png">
             ...
             <div class ="Historia Mision y vision">
...
<td style="height: 20px;">&nbsp;</td>
                ...
                <table align="center">
<tbody>
<td style="height: 98px; width: 722px; background-image: url('http://s2.subirimagenes.com/privadas/previo/thump_2256185banner.jpg'); background-repeat: no-repeat; margin-left: 90px; vertical-align: middle;" colspan="3"><span style="color: #ffffff; font-size: 25px; text-shadow: 1px 1px 1px #000000; font-weight: bold; text-align: center; margin-left: 15px;"> Historia - Misión - Visión </span></td>
</tbody>
                  </table>
</div>
 ...
 <div class="caja-titulo">    
                ...
                <div class="caja-contenido">
                  ...
                  <img src="http://www.famisanar.com.co/images/historia.jpg" align="left"> 
                
                  <p>
                  Nuestra organizacion nace en julio de 1995 bajo la alianza estratégica entre COMEVA y MEDPLUS para el área de salud, aplicando la experiencia acumulada como cajas durante más de 42 años, cristalizando su experiencia, eficiencia y espíritu de servicio. Famisanar ha destinado gran parte de sus esfuerzos para brindar soluciones oportunas y efectivas, garantizando una calidad de atención en salud  a los trabajadores en Colombia.

                  Nuestro gran desarrollo tecnológico, denominado Portal Transaccional, que nos permite dar soporte a las empresas en temas de autorizaciones de servicios médicos, manejo y control de incapacidades que nos ubica como una de las EPS de mayor recordacióndel sector de las cajas socias.
                  </p>
                </div>
              </div>
              ...
              <div class="caja">
                ...
                <div class="caja-contenido">
                  ...
                  <center><img src="http://www.famisanar.com.co/images/mision.jpg" height="180" width ="180"></center> 
                  <p>
                    Somos una empresa que gestiona el riesgo en salud de sus afiliados con enfoque preventivo; de forma amable, confiable y eficiente. 
                  </p>
                </div>
              </div>
              ...
              <div class="caja">
                <div class="caja-titulo">                   
                      <h1>Nuestros Vision</h1>                    
                </div>
                <div class="caja-contenido">
                  
                       <center><img src="http://www.famisanar.com.co/images/vision.jpg" height="180" width ="180"></center> 
                   <p>
                    Ser reconocidos y elegidos por: La innovación, agilidad y sencillez de nuestro modelo humanizado de atención en salud.
                  </p>
